...
// Import
var _a = require('@polkadot/api'), ApiRx = _a.ApiRx, ApiPromise = _a.ApiPromise, WsProvider = _a.WsProvider;
//let ApiPromise = require('@polkadot/api').ApiPromise;
//let WsProvider = require('@polkadot/api').WsProvider;
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var wsProvider, api, chain, lastHeader, count, unsubHeads;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wsProvider = new WsProvider('wss://rpc.polkadot.io');
                    return [4 /*yield*/, ApiRx.create({ provider: wsProvider })];
                case 1:
                    api = _a.sent();
                    // Do something
